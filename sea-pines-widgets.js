    ...
    <section class="sp-w3-section">
      ...
      <div class="sp-w3-header">
        <div>
          ...
          <p class="sp-w3-subtitle">Gated Communities &nbsp;·&nbsp; Oceanfront &nbsp;·&nbsp; Golf &nbsp;·&nbsp; Marina</p>
        </div>
        <div class="sp-w3-header-right">
          ...
          <a href="/neighborhoods" class="sp-w3-header-cta">View All Neighborhoods &nbsp;→</a>
        </div>
      </div>
        ...
        <div class="sp-w3-track" id="sp-w3-track">
          <a class="sp-w3-card" href="/palmetto-dunes">
            ...
            <div class="sp-w3-card-content">
              ...
              <div class="sp-w3-card-price">From <strong>$750K</strong> &nbsp;·&nbsp; 3 Golf Courses</div>
              <div class="sp-w3-card-cta">Explore →</div>
            </div>
          </a>
          <a class="sp-w3-card" href="/wexford">
            ...
            <div class="sp-w3-card-content">
              ...
              <div class="sp-w3-card-price">From <strong>$900K</strong> &nbsp;·&nbsp; Private Marina</div>
              <div class="sp-w3-card-cta">Explore →</div>
            </div>
          </a>
          <a class="sp-w3-card" href="/hilton-head-plantation">
            ...
            <div class="sp-w3-card-content">
              ...
              <div class="sp-w3-card-desc">The island's largest gated community — 4,000 acres with four golf courses, a beach club, and deep community roots.</div>
              <div class="sp-w3-card-price">From <strong>$600K</strong> &nbsp;·&nbsp; 4,000 Acres</div>
              <div class="sp-w3-card-cta">Explore →</div>
            </div>
          </a>
          <a class="sp-w3-card" href="/port-royal">
            ...
            <div class="sp-w3-card-content">
              ...
              <div class="sp-w3-card-desc">A quiet, understated enclave on the island's north end — pristine oceanfront lots and three championship courses.</div>
              <div class="sp-w3-card-price">From <strong>$800K</strong> &nbsp;·&nbsp; Oceanfront</div>
              <div class="sp-w3-card-cta">Explore →</div>
            </div>
          </a>
          <a class="sp-w3-card" href="/shipyard">
            ...
            <div class="sp-w3-card-content">
              ...
              <div class="sp-w3-card-price">From <strong>$450K</strong> &nbsp;·&nbsp; Beach Club</div>
              <div class="sp-w3-card-cta">Explore →</div>
            </div>
          </a>
          <a class="sp-w3-card" href="/long-cove">
            ...
            <div class="sp-w3-card-content">
              ...
              <div class="sp-w3-card-desc">Pete Dye's personal masterpiece on Broad Creek — a private, intimate club where members know each other by name.</div>
              <div class="sp-w3-card-price">From <strong>$1.1M</strong> &nbsp;·&nbsp; Pete Dye Course</div>
              <div class="sp-w3-card-cta">Explore →</div>
            </div>
          </a>
        </div>
